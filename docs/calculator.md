...
| 样例端到端核对 | ✅ 招标侧 14 条数值要求 → 我方语料能力 16 条（product-guide 12 + qualifications 4）→ 全配对，0 unknown |
...
我方能力   16 条：product-guide.md 12 + qualifications-and-service.md 4（cases.md 业绩金额被正确忽略）
                   （product-guide 12 含 M2 补录的裸"800 万像素"行——单位"像素"唯一落到分辨率）
